...
const defaultProducts = [
  ...
  {
    id: "3",
    nameAr: "بوكس 10 حمامات زاجل طازج ",
    nameEn: "Pigeon 10 Pieces",
    descriptionAr: "حمام طازج من مزرعة الثنيان، 10 حبة، مربى بعناية",
    descriptionEn:
      "Fresh pigeon from Al Thunayan Farm, 10 pieces, carefully raised",
    price: "8.000",
  ...
  {
    id: "4",
    nameAr: "بوكس 20 حمامة زاجل طازج ",
    nameEn: "Pigeon 20 Pieces",
    descriptionAr: "حمام طازج من مزرعة الثنيان، 20 حبات",
    descriptionEn: "Fresh pigeon from Al Thunayan Farm, 20 pieces",
    price: "4.000",
    image: "/api/images/pigeon",
    category: "pigeon",
    inStock: true,
